...
/*
 * code copied from -ankitagrahari's code -  https://github.com/ankitagrahari/Tryouts.git
 */
...
public class TempletAesAlgo {

    // public static final int AES_KEY_SIZE = 256;
    // public static final int AES_KEY_SIZE_bst = 128;
    ...
    /**
     * Accumulator which takes DataSourceId and generates the SecretKey used for
     * Encryption and Decryption
     * 
     * @param dataSourceId
     * @return SecretKeySpec
     */
    public SecretKey generateSecretKey(String dataSourceId) { // dataSourceId = 609238
     ...
     * Since the GCM mode works on Streams, it doesn't require any Padding. So
     * NoPadding is given.
     * 
     * @param toEncrypt
     * @param secretKey
    ...
    public static void main(String[] args) {
        ...
        String toEncrypt = "Test string 1234567890";
        TempletAesAlgo obj = new TempletAesAlgo();
        ...
        //
        // byte[] encrypted = obj.encrypt(toEncrypt,
        // obj.generateSecretKey(dataSourceId), obj.generateGCMParamSpec());
        ...
        // byte[] decrypted = obj.decrypt(base64Decrypt,
        // obj.generateSecretKey(dataSourceId), obj.generateGCMParamSpec());
